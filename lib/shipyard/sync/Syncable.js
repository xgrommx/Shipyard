...
var Syncable = new Class({
    ...
    initialize: function Syncable(data) {
        // order matters here, since this sets up an Observable.property
        // that is then processed in this.parent();
        this._setupPKObserver();
        this.parent(data);
    },
    ...
    _setupPKObserver: function _setupPKObserver() {
        var pk = this.pk;
        this.pk = Observable.property(function(value) {
...
Observable.prototype.observe.call(Syncable.prototype, 'pk',
	function(newPK, oldPK) {
