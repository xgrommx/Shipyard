...
var Request = module.exports = exports = new Class({
    ...
    onStateChange: function onStateChange() {
        ...
        if (this.isSuccess()) {
            this.emit('success', this.response.text, this.response.xml);
        } else {
            this.emit('failure', this.response.text, this.response.xml);
        }
        this.emit('complete', this.response.text, this.response.xml);
    }
