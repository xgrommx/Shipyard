...
var Model = module.exports = new Class({
	...
	toJSON: function toJSON() {
		var data = {};
		for (var key in this.constructor.__fields) {
			data[key] = this.constructor.__fields[key].serialize(this.get(key));
		}
		return data;
	},
...
Model.Mutators.fields = function mutator_fields(fields) {
