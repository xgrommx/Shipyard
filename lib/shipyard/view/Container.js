...
module.exports = new Class({
	...
	initialize: function Container(params) {
		...
		childViews.observe('array', function onArrayChange() {
			container.__onChildViewsChange.apply(container, [this].concat(SLICE.call(arguments)));
		});
	...
	__onChildViewsChange: function __onChildViewsChange(childViews, index, removed, added) {
		var child;
		if (removed.length) {
